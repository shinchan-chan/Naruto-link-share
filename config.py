...
# Messages
# 👇 keep {mention} as placeholder here, we’ll format it later inside bot.py
...
›› ᴏᴡɴᴇʀ: <a href='https://t.me/Devil_Eyes_Xe'>Unknown</a>"""
